...
def reduce(args, train_list):
    ...
    np.save(f'datasets/{args.dataset}/remix_processed/train_bag_feats_proto_{args.num_prototypes}_v2.npy', prototypes)
    np.save(f'datasets/{args.dataset}/remix_processed/train_bag_feats_shift_{args.num_prototypes}_v2.npy', semantic_shifts)
    ...
    train_labels = []
    train_list_txt = open(f'datasets/{args.dataset}/remix_processed/train_list_v2.txt', 'w')
    for i in train_list:
...
if __name__ == '__main__':
    ...
    train_list = f'datasets/{args.dataset}/remix_processed/train_list_v2.txt'
