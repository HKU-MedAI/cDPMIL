...
```shell
python3 tools/process_dataset.py --dataset Camelyon --task download
```
...
```shell
python3 tools/process_dataset.py --dataset Camelyon --task convert
```
...
```shell
python3 tools/process_dataset.py --dataset Camelyon --task split
```

Or you can put all the commands together as:

```shell
python3 tools/process_dataset.py --dataset Camelyon --task download convert split
```
## UniToPatho
